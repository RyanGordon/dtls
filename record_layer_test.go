...
func TestRecordLayerRoundTrip(t *testing.T) {
	for _, test := range []struct {
		...
		data, marshalErr := r.Marshal(1200)
...
func TestLargeHandshakeMessageIsFragmented(t *testing.T) {
	expectedPackets := [][]byte{
		{
			,
		},
		{
			,
		},
	}
	...
	packets, err := record.Marshal(300)
	if err != nil {
		t.Error(err)
	}
	...
	if err != nil {
		t.Error(err)
	} else if !reflect.DeepEqual(packets, expectedPackets) {
		t.Errorf("largeHandshakeMessageIsFragmented marshal: got %#v, want %#v", packets, expectedPackets)
	}
}
